...
rixwoodling@Mac 101zombies % git add 101zombies.c
rixwoodling@Mac 101zombies % git commit -m "Add author header"
[detached HEAD b70db0e] Add author header
 1 file changed, 4 insertions(+)
rixwoodling@Mac 101zombies % cat 101zombies.c             
// 101 Zombies
// Turn-based survival game for Flipper Zero.
// Copyright (c) 2026 Rix Woodling. All rights reserved.
